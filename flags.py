...
parser.add_argument('--prompt_dropout', default=0, type=float)
...
parser.add_argument('--past_key_value_file', default='llama3_{}_past_key_value.pt', type=str)
...
parser.add_argument('--clip_text_embed_file', default='llama3_total_clip_text_embeddings.pt', type=str)
parser.add_argument('--clip_visual_feature_file', default='kolors_clip_visual_features.pt', type=str)
parser.add_argument('--save_last', action="store_true")
parser.add_argument('--betas', nargs=2, type=float, default=[0.9, 0.999])
parser.add_argument('--clip_kolors_embed_file', default='kolors_clip_visual_features.pt', type=str)
...
parser.add_argument('--clip_basemodel_path',type=str, default='openai/clip-vit-base-patch16')
parser.add_argument("--datasets_test_new", type=str, help="Dataset to test(new)")
parser.add_argument('--rawclip', action='store_true', default=False, help='Enable rawclip')
parser.add_argument('--fix_lam', action='store_true', default=False, help='Fix lambda parameter')
parser.add_argument('--lam_res', type=float, default=0.1)
parser.add_argument('--weight_res', type=float, default=0.1)
parser.add_argument("--model_base", type=str, default='meta-llama/Meta-Llama-3-8B-Instruct')
parser.add_argument('--confusion_weight', type=float, default=0.1)
parser.add_argument('--patch_aug_config', type=str, default='', help='JSON string of patch augmentation config')
parser.add_argument('--use_imbalance', action='store_true', default=False, help='Whether to use imbalanced dataset')
parser.add_argument('--imb_ratio', type=float, default=10.0, help='Imbalance ratio when use_imbalance is True')
parser.add_argument('--mag_temperature', type=float, default=1.0, help='Temperature for MAG attention softmax')
parser.add_argument('--token_modification_method', type=str, default='importance_based_dropout',
                    choices=['importance_based_dropout'],
                    help='Method to handle unimportant tokens')
parser.add_argument('--noise_injection_sigma', type=float, default=0.03,
                    help='Standard deviation for Gaussian noise injection if method is "noise"')
parser.add_argument('--noise_max_prob', type=float, default=0.5,
                    help='Max noise probability for importance-based stochastic noise (least important tokens)')
parser.add_argument('--noise_min_prob', type=float, default=0.1,
                    help='Min noise probability for importance-based stochastic noise (most important tokens)')
parser.add_argument('--epoch_dropout', type=int, default=10,help='draw image for dropout')
